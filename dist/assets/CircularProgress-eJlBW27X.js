import{bw as R,ac as x,aB as c,ad as o,bx as _,r as w,ag as N,ah as z,j as v,w as E,ai as B,by as F}from"./index-rtla7T4r.js";const I=["className","color","disableShrink","size","style","thickness","value","variant"];let l=r=>r,b,P,S,$;const a=44,K=R(b||(b=l`
  0% {
...
`)),W=r=>{const{classes:s,variant:e,color:t,disableShrink:d}=r,u={root:["root",e,`color${c(t)}`],svg:["svg"],circle:["circle",`circle${c(e)}`,d&&"circleDisableShrink"]};return B(u,F,s)},G=x("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(r,s)=>{const{ownerState:e}=r;return[s.root,s[e.variant],s[`color${c(e.color)}`]]}})(({ownerState:r,theme:s})=>o({display:"inline-block"},r.variant==="determinate"&&{transition:s.transitions.create("transform")},r.color!=="inherit"&&{color:(s.vars||s).palette[r.color].main}),({ownerState:r})=>r.variant==="indeterminate"&&_(S||(S=l`
    ...
    `),U)),Z=w.forwardRef(function(s,e){const t=N({props:s,name:"MuiCircularProgress"}),{className:d,color:u="primary",disableShrink:D=!1,size:h=40,style:j,thickness:i=3.6,value:p=0,variant:k="indeterminate"}=t,M=z(t,I),n=o({},t,{color:u,disableShrink:D,size:h,thickness:i,value:p,variant:k}),m=W(n),f={},g={},y={};if(k==="determinate"){const C=2*Math.PI*((a-i)/2);f.strokeDasharray=C.toFixed(3),y["aria-valuenow"]=Math.round(p),f.strokeDashoffset=`${((100-p)/100*C).toFixed(3)}px`,g.transform="rotate(-90deg)"}return v.jsx(G,o({className:E(m.root,d),style:o({width:h,height:h},g,j),ownerState:n,ref:e,role:"progressbar"},y,M,{children:v.jsx(L,{className:m.svg,ownerState:n,viewBox:`${a/2} ${a/2} ${a} ${a}`,children:v.jsx(T,{className:m.circle,style:f,ownerState:n,cx:a,cy:a,r:(a-i)/2,fill:"none",strokeWidth:i})})}))});export{Z as C};
