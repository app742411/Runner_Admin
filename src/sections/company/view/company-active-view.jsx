...
import { useActiveCompanies } from 'src/features/company/useCompanies';
...
export function CompanyActiveView() {
  ...
  return (
    <DashboardContent maxWidth={false}>
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 5 }}>
        <Stack spacing={1}>
          <Typography variant="h4">{t('company.view.active')}</Typography>
          <MuiBreadcrumbs
            separator={
              <Box
          ...
          >
            ...
            <Typography color="text.primary">{t('company.view.active')}</Typography>
          </MuiBreadcrumbs>
        </Stack>
      </Stack>
      ...
      <Card>
        <CompanyTableToolbar
          ...
          cityOptions={['New York', 'London', 'Zurich', 'Seattle', 'Küsnacht']}
          hideSubscription
        />
