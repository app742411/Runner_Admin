...
import { usePendingCompanies } from 'src/features/company/useCompanies';
  ...
  return (
    <DashboardContent maxWidth={false}>
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 5 }}>
        <Stack spacing={1}>
          <Typography variant="h4">{t('company.view.pending')}</Typography>
          <MuiBreadcrumbs
            separator={
              <Box
          ...
          >
            ...
            <Typography color="text.primary">{t('company.view.pending')}</Typography>
          </MuiBreadcrumbs>
        </Stack>
      </Stack>
