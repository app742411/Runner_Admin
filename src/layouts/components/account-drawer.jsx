          ...
          <Stack direction="row" spacing={1} flexWrap="wrap" justifyContent="center" sx={{ p: 3 }}>
            {[...Array(3)].map((_, index) => (
              <Tooltip
                ...
                title={t('account.switchTo', { name: _mock.fullName(index + 1) })}
              >
                <Avatar
            ...
            <Tooltip title={t('account.addAccount')}>
              <IconButton
                sx={{
              ...
              return (
                ...
                >
                  ...
                  <Box component="span" sx={{ ml: 2 }}>
                    {option.label === 'Home' ? rootLabel : (labelMap[option.label] || option.label)}
                  </Box>
